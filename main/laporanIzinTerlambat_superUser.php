...
$total_query = "SELECT COUNT(*) as total FROM terlambat";
...
$query_terlambat = "
    SELECT d.tanggal_izin, u.namaLengkap, d.alasan_terlambat, d.waktu_kedatangan, d.created_at
    FROM terlambat d 
    JOIN users u ON d.user_id = u.id 
    ORDER BY d.tanggal_izin DESC
    LIMIT ? OFFSET ?
";
...
<head>
    ...
    <title>Tabel Laporan Izin Terlambat</title>
</head>
<style>
.circle {
...
<body style="background-color: rgb(238, 238, 238);">
    ...
    <div class="d-flex mt-3 me-4 ms-3">
        <div class="row w-100">
            ...
            <div class="col">
                <h4 style="font-weight: bold; margin: 0; padding: 0;">Data Laporan Perizinan Terlambat</h4>
            </div>
        </div>
    </div>
    ...
    <div class="container mt-5" style="font-size: 12px;">
        ...
        <table class="table table-bordered mt-1">
            ...
            <tbody>
                <?php if ($result_terlambat->num_rows > 0): ?>
                    <?php while ($row = $result_terlambat->fetch_assoc()): ?>
                        <tr>
                            ...
                            <td><?= htmlspecialchars($row['waktu_kedatangan']) ?>
                ...
                <?php else: ?>
                    <tr>
                        <td colspan="7" class="text-center">Tidak ada data laporan Izin Terlambat.</td>
                    </tr>
                <?php endif; ?>
            </tbody>
        </table>
